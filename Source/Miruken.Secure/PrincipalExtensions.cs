...
{
    public static ClaimsIdentity RequireClaims(this IPrincipal principal)
    {
    ...
    public static ClaimsIdentity RequireAuthenticatedClaims(this IPrincipal principal)
    {
        var identity = principal.Identity;
    ...
    public static bool HasClaim(this ClaimsIdentity identity, string type, string value = null)
    {

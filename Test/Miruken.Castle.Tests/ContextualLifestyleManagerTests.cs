namespace Miruken.Castle.Tests
{
    ...
    public class ContextualLifestyleManagerTests
    {
        ...
        {
            var controller1 = P<IContainer>(_rootContext).Resolve<Controller>();
            var controller2 = P<IContainer>(_rootContext).Resolve<Controller>();
        ...
        {
            var controllers1 = P<IContainer>(_rootContext).ResolveAll<Controller>();
        ...
        public void Should_Resolve_Different_Instance_Per_Context()
        {
            ...
            {
                var controller1 = P<IContainer>(_rootContext).Resolve<Controller>();
                var controller2 = P<IContainer>(child).Resolve<Controller>();
                Assert.IsInstanceOfType(controller1, typeof(Controller));
        ...
        {
            var container  = P<IContainer>(_rootContext);
        ...
        public void Should_Release_Components_When_Context_Ends()
        {
            ...
            var controller = P<IContainer>(child).Resolve<Controller>();
        ...
        {
            var controller = P<IContainer>(_rootContext).Resolve<Controller>();
